...
export const POSPizzaModal = ({ item, isOpen, onClose, onAddToOrder, editingItem }: POSPizzaModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-[98vw] w-[98vw] p-2 lg:p-4 pt-1.5 lg:pt-3 overflow-y-auto max-h-[98vh] text-slate-900" style={{ backgroundColor: '#dbeafe', background: '#dbeafe', textRendering: 'geometricPrecision', WebkitFontSmoothing: 'antialiased' as any, display: 'block', height: 'auto', maxHeight: '98vh' }}>
        ...
        <div className="space-y-px lg:space-y-1.5" style={{ flex: '0 0 auto' }}>
          ...
          {/* Footer inside same container - no gap possible */}
