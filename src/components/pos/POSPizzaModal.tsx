...
export const POSPizzaModal = ({ item, isOpen, onClose, onAddToOrder, editingItem }: POSPizzaModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="!flex !flex-col max-w-[98vw] w-[98vw] p-2 lg:p-4 pt-1.5 lg:pt-3 overflow-hidden max-h-[98vh] !h-auto !gap-0.5 text-slate-900" style={{ backgroundColor: '#dbeafe', background: '#dbeafe', textRendering: 'geometricPrecision', WebkitFontSmoothing: 'antialiased' as any }}>
