      ...
      <DialogContent className="max-w-6xl p-3 pt-2 gap-1 overflow-hidden max-h-[calc(100vh-24px)] bg-white text-slate-900" style={{ backgroundColor: 'white' }}>
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-start gap-8">
            ...
            <div className="flex items-center gap-2">
              <span className={cn(
                "text-xs font-medium px-3 py-2 rounded whitespace-nowrap",
              ...
              {(() => {
                ...
                return (
                  <span className={cn(
                    "text-xs font-medium px-2 py-2 rounded whitespace-nowrap",
                  ...
                  {(['left', 'whole', 'right'] as Side[]).map(side => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "px-2 py-2 text-xs rounded border font-medium transition-colors",
                          isDisabled 
              ...
              {(() => {
                ...
                return (
                  <span className={cn(
                    "text-xs font-medium px-2 py-2 rounded",
